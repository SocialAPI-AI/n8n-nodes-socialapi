...
export const mediaFields: INodeProperties[] = [
	...
	{
		displayName: 'Source', name: 'source', type: 'options', default: 'binary',
		displayOptions: showFor(['upload']),
		options: [
			{ name: 'Binary File', value: 'binary', description: 'Use a binary property from a previous node' },
	...
	{
		displayName: 'Options', name: 'uploadOptions', type: 'collection', placeholder: 'Add Option', default: {},
		displayOptions: showFor(['upload']),
		options: [
			{ displayName: 'Content Type', name: 'media_type', type: 'string', default: '', description: 'Override the detected MIME type' },
			{ displayName: 'File Name', name: 'filename', type: 'string', default: '', description: 'Override the detected file name' },
		],
	},
	// id param
	{ displayName: 'Media ID', name: 'mediaId', type: 'string', default: '', required: true, displayOptions: showFor(['delete']) },
	// list pagination
	{ displayName: 'Return All', name: 'returnAll', type: 'boolean',
																																																	description: 'Whether to return all results or only up to a given limit', default: false, displayOptions: showFor(['getAll']) },
	{ displayName: 'Limit', name: 'limit', type: 'number',
																																								description: 'Max number of results to return', default: 50, typeOptions: { minValue: 1 },
